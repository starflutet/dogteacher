...
%>
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		<a class="navbar-brand" href="index.jsp">개선생강의평가 웹 사이트</a>
			...
			<div class="card-body">
				...
				<div class="row">
					<div class="col-9 text-left">
						...
						개꿀딱<span style="color:red;"><%= evaluation.getComfortableScore() %></span>
...
%>
	...
	<footer class="bg-dark mt-4 p-5 text-center" style="color: #FFFFFF;">
		Copyright &copy; 2020 준현이 맹글어봄 보리보리.
	</footer>
	<%-- 제이쿼리 자바스크립트 추가하기 --%>
